calMatchMisMatch <- function(alignment, chunksize=60, returnlist=FALSE) {
    ...
    resultStr = paste("mismatch count = ", misMatchInt, " match count = ", matchInt)
    print(resultStr)
